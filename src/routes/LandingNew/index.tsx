...
import tiktok4 from "../../assets/arystan.png";
import tiktok5 from "../../assets/bsima.png";
  ...
  useEffect(() => {
    const handleResize = () => {
      if (window.innerWidth > 900) {
        window.open("https://comabooks.org", "_self");
      }
    };
    ...
    <div className="landing-new-page">
      ...
      <div className="landing-new-show">
        ...
        <div className="landing-new-tiktoks">
          <Link
            to="https://www.instagram.com/reel/C7zUgJwxJ2B/?igsh=MWE2cXFvYnl1bW1qOA=="
          ...
          <Link
            to="https://www.instagram.com/reel/C5O1O5yLDvL/?igsh=azFubGE4Ym5sbTAw"
            className="landing-new-tiktok"
          >
            <img src={tiktok3} />
          </Link>
          <Link
            to="https://vm.tiktok.com/ZMr86dyAM/"
            className="landing-new-tiktok"
          >
            <img src={tiktok1} />
          </Link>
          <Link
            to="https://vm.tiktok.com/ZMr86BBgv/"
            className="landing-new-tiktok"
          >
            <img src={tiktok5} />
          </Link>
          <Link
            to="https://vm.tiktok.com/ZMr86RsSw/"
            className="landing-new-tiktok"
          >
            <img src={tiktok6} />
          </Link>
