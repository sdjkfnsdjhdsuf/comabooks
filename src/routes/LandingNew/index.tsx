    ...
    <div className="landing-new-page">
      <div className={`landing-new-header ${isScrolled ? "scrolled" : ""}`}>
        <div className={`landing-new-menu ${isNavVisible ? "show" : ""}`}>
          <div
            className={`landing-new-menu-logo ${isScrolled ? "scrolled" : ""}`}
          >
            comabooks
          </div>
      ...
      <div className="landing-new-first">
        <div className="landing-new-first-title">
          Посвяти книгу {currentWord}
        </div>
        <div className="landing-new-first-text">
          С помощью нашего издательства вы сможете написать собственную книгу
          своим любимым
        </div>
        <button className="landing-new-first-order" onClick={handleOrder}>
          Заказать
        </button>
      </div>
      ...
      <div className="landing-new-video">
        ...
        <div className="landing-new-video-text">
          Почувствуй себя в роли автора и порадуй близких!
        </div>
        <button className="landing-new-video-order" onClick={handleOrder}>
          Заказать
        </button>
      </div>
      ...
      <div className="landing-new-show">
        ...
        <div className="ui-text">
          Сперва нужно зайти в личный кабинет и выбрать своего получателя.
        </div>
      ...
      <div className="landing-new-show">
        ...
        <div className="ui-text">
          Более десяти разных дизайнов, возможность вписать название книги и
          указать автора.
        </div>
            ...
            <div className="ui-preview">
              <div className="ui-preview-itself cover">
                <div className="ui-preview-info cover">
                  <div className="ui-preview-info cover-n">
                    {bookTitle || "Любимой"}
                  </div>
                  <div className="ui-preview-info cover-a">
                    {authorName || "Ануар Алиаскаров"}
                  </div>
                </div>
      ...
      <div className="landing-new-show">
        ...
        <div className="ui-text">
          Вопросов около 200, но на все отвечать необязательно, главное
          заполнить 150-200 страниц.
        </div>
              ...
              <div className="ui-preview">
                <div className="ui-preview-itself answer">
                  <div className="ui-preview-info answer">
                    <div className="ui-preview-info answer q">
                      {getQuestionBasedOnRecipient(recipient) ||
                        "Представьтесь: как вас зовут, кому и почему вы решили посвятить книгу?"}
                    </div>
                    <div className="ui-preview-info answer a">
                      {answer || ""}
                    </div>
                  </div>
      ...
      <div className="landing-new-show">
        ...
        <div className="ui-text">
          Сохраните общие воспоминания, в виде фото, даты и описания.
        </div>
        ...
        <div className="ui1">
          <div className="ui1-info">
            ...
            <div className="ui-preview">
              <div
                className="ui-preview-itself photo"
                style={{
              ...
              >
                <div className="ui-preview-info photo">
                  <div className="ui-preview-info photo d">
                    {date || "12.12.2024"}
                  </div>
                  <div className="ui-preview-info photo d2">
            ...
            <textarea
              ...
              className="ui-textarea-photo"
              value={description}
              onChange={handleDescriptionChange}
            />

            <label className="ui-label">Фото</label>
            <label htmlFor="fakeupload" className="ui-upload">
              Добавить фото
            </label>
            <input
              type="file"
      ...
      <div className="landing-new-show">
        ...
        <div className="r-text">
          Со всеми отзывами можно ознакомиться в наших соц.сетях
        </div>
        <div className="landing-new-tiktoks">
          <Link
            to="https://www.instagram.com/reel/C8ysJ4gN9Im/?igsh=MWtuemx3YmVrcW1vZQ=="
            className="landing-new-tiktok"
          >
            <img src={tiktok4} />
          </Link>
          <Link
            to="https://vm.tiktok.com/ZMr86BLJb/"
            className="landing-new-tiktok"
          >
            <img src={tiktok2} />
          </Link>
          ...
          <Link
            to="https://www.instagram.com/reel/C8CS1heN8if/?igsh=MTVya3FwbjN4OHQ2cQ=="
            className="landing-new-tiktok"
          >
            <img src={tiktok1} />
          </Link>
          ...
          <Link
            to="https://www.instagram.com/reel/C-2q048srVd/?igsh=MXFrcHZhNDljdXNpeg=="
            className="landing-new-tiktok"
          >
            <img src={tiktok6} />
          </Link>
        ...
        <div className="landing-new-reviews">
          <div className="landing-new-review">
            Я не ожидала такого качества, оформления. Я в шоке. Получилось
            лучше, чем ожидала. Кто придумал эту идею с книгой - гений 🥹😍😍
          </div>
          <div className="landing-new-review">
            Это лучшее, что я дарил. Подарок очень понравился, спасибо вам
            большое
          </div>
          <div className="landing-new-review">
            Благодарю вас! Жена была поражена. Удивилась, и даже немного
            всплакнула.
          </div>
          <div className="landing-new-review">
            Добрый вечер! Подруга переполнена эмоциями, не может поверить, что
            ей посвятили книгу о нашей дружбе. Говорит вообще не ожидала.
          </div>
          <div className="landing-new-review">
            Книгу передали. Благодарю за вашу работу, сестре очень понравилось.
            Желаю дальнейших вам успехов!
          </div>
          <div className="landing-new-review">
            Извините, что поздно пишу - просто хотела сказать искренне спасибо!
            Такой душевный подарок подарила маме.
          </div>
          <div className="landing-new-review">
            Благодарю за такую возможность подарить эмоции близкому человеку,
            это действительно круто. Книга сделана очень классно, это так
            продуманно! Нашей подруге все понравилось, остались воспоминания на
            всю жизнь!
          </div>
        </div>
        <Link
          className="landing-new-review-instagram"
          to="https://www.instagram.com/stories/highlights/18005192363276565/"
        >
          Больше отзывов в Instagram <InstagramIcon />
        </Link>
      </div>
      ...
      <div className="landing-new-footer">
        <div className="footer-preview">
          <div className="footer-preview-info">
            <div className="footer-preview-info-b">
              {bookTitle || "Любимой"}
            </div>
            <div className="footer-preview-info-a">
              {authorName || "Ануар Алиаскаров"}
            </div>
          </div>
        ...
        <div className="landing-new-footer-title">
          Сделай подарок, который запомнится на века
        </div>
        <button className="landing-new-footer-order" onClick={handleOrder}>
          Заказать
        </button>
      </div>
    </div>
