  ...
  return (
    <div className='policy-container'>
        ...
        <div className='policy-term'>
            ...
            <div className='policy-term-text'>Если у вас есть вопросы относительно этой политики конфиденциальности, вы можете связаться с нами по телефону +996 702 637 463. Временно </div>
        </div>
        ...
        <div className='policy-term'>
            <div className='policy-term-title'>Контактная информация</div>
            <div className='policy-term-text'>Для дополнительных вопросов о политике использования сайта, пожалуйста, свяжитесь с нами по телефону +996 702 637 463. Временно.</div>
        </div>
