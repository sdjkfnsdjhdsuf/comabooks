...
function Landing() {
  ...
  const [currentRecipient, setCurrentRecipient] = useState(
    "Представьте, как вы посвящаете книгу девушке. Такого подарка она еще точно не получала!"
  );
  const recipients = [
    "Представьте, как вы посвящаете книгу девушке. Такого подарка она еще точно не получала!",
    ...
    <div className="landing-page">
      ...
      <div className="hiro">
        ...
        <div className="hiro-column">
          ...
          <div className="hiro-column-text">
            С нами вы можете посвятить собственную книгу любимым: второй
            половинке, родителям, друзьям и т.д.
          </div>
          <div className="hiro-column-button">
            <button onClick={handleOrder} className="landing-button">
              Заказать
            </button>
          </div>
        </div>
      ...
      <div className="two">
        ...
        <div className="two-text">
          Заказав у нас, вы получите целую книгу на 200-300 страниц, наполненную
          вашими лучшими воспоминаниями.
        </div>
      ...
      <div className="three">
        ...
        <div className="three-text">
          Наши книги идут в формате интервью (вопрос / ответ), у нас есть более
          десяти форматов со списком вопросов. Вам нужно на них ответить у нас
          на платформе.
        </div>
        ...
        <div className="survey">
          <div className="survey-title">
            Вопросы проверены психологами Университета Мичигана. Они выявили,
            что эта книга способствует укреплению отношений на 88%.
          </div>
      ...
      <div className="process">
        ...
        <div className="process-2">
          <div className="process-step">
            ...
            <div className="process-step-text">
              После оплаты вы получите личный кабинет на нашей платформе. Далее,
              можно приступать к заполнению содержания вашей будущей книги. 
            </div>
          </div>
        ...
        <div className="process-2">
          <div className="process-step">
            ...
            <div className="process-step-text">
              На платформе вы будете отвечать на вопросы. Можно добавлять
              фотографий и создать обложку. 
            </div>
          </div>
        ...
        <div className="process-2">
          <div className="process-step">
            ...
            <div className="process-step-text">
              Как только вы заполните содержание, наши редакторы приступят к
              корректировке, а дизайнеры займутся версткой. 
            </div>
          </div>
        ...
        <div className="process-2">
          <div className="process-step">
            ...
            <div className="process-step-text">
              Далее, книга отправится на печать. При готовности, мы аккуратно ее
              упакуем и отправим к вам экспресс-доставкой. 
            </div>
          </div>
      ...
      <div className="results">
        ...
        <div className="results-title">
          Вот такую книгу на 200-300 страниц вы получите через 4-7 дней после
          начала!
        </div>
      ...
      <div className="results">
        ...
        <div className="reviews-row">
          <Link to="https://vm.tiktok.com/ZMMxUDbva/">
            <img className="results-img" src={tiktok1} />
          </Link>
          <Link to="https://vm.tiktok.com/ZMMxsJC97/">
            <img className="results-img" src={tiktok2} />
          </Link>
          <Link to="https://www.instagram.com/reel/C5O1O5yLDvL/?igsh=azFubGE4Ym5sbTAw">
            <img className="results-img" src={tiktok3} />
          </Link>
          <Link to="https://www.instagram.com/reel/C51GG76Nju1/?igsh=MWo1cHJnM3l6M2s1bQ%3D%3D">
            <img className="results-img" src={tiktok4} />
          </Link>
        </div>
      </div>
      ...
      <div className="price">
        ...
        <div className="price-text">
          В эту цену входит все - редактура, верстка, печать и упаковка. 
        </div>
        <div className="price-text">
          Можно предоплатой либо Kaspi рассрочкой 0-0-12. 
        </div>
        <img src={kaspi} />
      </div>
