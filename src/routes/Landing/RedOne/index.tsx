    ...
    <div className="landing-upd">
      <div className="landing-upd-header">
        ...
        <div className="landing-upd-header-links">
          ...
          <Link to={'/order'}>Цены и вопросы</Link>
          <Link to={'/policies'}>Условия использования</Link>
          <button onClick={() => navigate('/login')} className="landing-upd-header-button-empty">Войти</button>
      ...
      <div className="landing-upd-header-mobile">
        ...
        <button onClick={() => navigate('/login')} className="landing-upd-header-button-filled">Войти</button>
      </div>
